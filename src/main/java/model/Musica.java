 ...
 * O ID é imutável e usado para identificação única.
 */
public class Musica {
    ...
    /** Construtor usado pela persistência (UUID fornecido) */
    ...
    /** Duplicidade agora é verificada por título + artista + álbum (case-insensitive) */
    @Override
